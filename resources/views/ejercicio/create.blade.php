...
@section('content')
    ...
    <!--                <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <h6 class="multisteps-form__title"><b>Seleccione los músculos que abarcará su ejercicio</b></h6>
                                <div class="multisteps-form__content">
                                    <div class="form-row mt-2 shadow-none p-3 mb-2 bg-light rounded">
                                        <div class="col">
                                            <div class="form-check">
                                                <input type="checkbox" id="checkbox-pecho" class="form-check-input checkbox-grupo">
                                                <label class="form-check-label" for="checkbox-pecho">Pecho</label>
                                            </div>
                                            <div class="form-group ml-4">
                                                <div class="form-check">
                                                    <input type="checkbox" name="musculos[]" value="pectoral-mayor" id="checkbox-pectoral-mayor" class="form-check-input checkbox-individual">
                                                    <label class="form-check-label" for="checkbox-pectoral-mayor">Pectoral mayor</label>
                                                </div>
                                                <div class="form-check">
                                                    <input type="checkbox" name="musculos[]" value="pectoral-menor" id="checkbox-pectoral-menor" class="form-check-input checkbox-individual">
                                                    <label class="form-check-label" for="checkbox-pectoral-menor">Pectoral menor</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            &lt;!&ndash; Agrega aquí los otros grupos musculares &ndash;&gt;
                                        </div>
                                    </div>
                                </div>
                            </div>
